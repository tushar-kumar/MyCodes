...
public class GUI {
    ...
    public GUI() {
        ...
        addBtn.setBounds(170, 280, 85, 25);
        addBtn.setForeground(Color.BLUE);
        addBtn.setBackground(Color.GREEN);
        addBtn.setFont(new Font("Comic Sans MS", Font.BOLD, 11));
        ...
        removeBtn.setBounds(260, 280, 85, 25);
        removeBtn.setForeground(Color.WHITE);
        removeBtn.setBackground(Color.RED);
        removeBtn.setFont(new Font("Comic Sans MS", Font.BOLD, 11));
        ...
        option = new JComboBox<String>(new String[] { "FCFS", "SJF", "SRTF" });
        ...
        frame = new JFrame("CPU Scheduler Using GUI");
